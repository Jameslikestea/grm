...
func (ou *ObjectUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ou.mutation.Package(); ok {
	...
	if value, ok := ou.mutation.Hash(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
...
func (ouo *ObjectUpdateOne) sqlSave(ctx context.Context) (_node *Object, err error) {
	...
	if value, ok := ouo.mutation.Package(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: object.FieldPackage,
	...
	if value, ok := ouo.mutation.Hash(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: object.FieldHash,
