...
func (rc *ReferenceCreate) check() error {
	if _, ok := rc.mutation.Package(); !ok {
		return &ValidationError{Name: "package", err: errors.New(`ent: missing required field "Reference.package"`)}
	}
	if _, ok := rc.mutation.Ref(); !ok {
		return &ValidationError{Name: "ref", err: errors.New(`ent: missing required field "Reference.ref"`)}
	}
	if _, ok := rc.mutation.Hash(); !ok {
		return &ValidationError{Name: "hash", err: errors.New(`ent: missing required field "Reference.hash"`)}
	}
	return nil
}
...
func (rc *ReferenceCreate) createSpec() (*Reference, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.Package(); ok {
